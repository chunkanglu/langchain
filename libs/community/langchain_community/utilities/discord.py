...
# TODO: uncomment when some method needs a discord package object in type hint
# if TYPE_CHECKING:
#     import discord
...
class DiscordAPIWrapper(BaseModel):
    ...
    def validate_environment(cls, values: Dict) -> dict:
        ...
        try:
            ...
            raise ImportError(
                "Could not import discord python package. "
                "Please install it with `pip install -U discord.py`."
            ) from e
    ...
    async def create_connection(self) -> AsyncGenerator[None, None]:
        ...
        Can be used to wrap each call to the Discord API for
        tools in this wrapper class.
